...
SUMMARY = "Search modules and expose exports onto a given namespace."
# WARNING: the following LICENSE and LIC_FILES_CHKSUM values are best guesses - it is
# your responsibility to verify that the values are complete and correct.
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://LICENSE;md5=4ddc1cf493a9fd2c9ea91077ba66ebb6 \
                    ...
                    file://package.json;md5=d8e9b4f378d5ed91d887b454472abcd3 \
...
SRC_URI = " \
    git://github.com/bodenr/expose;protocol=https \
    npmsw://${THISDIR}/${BPN}/npm-shrinkwrap.json \
    "

# Modify these as desired
PV = "0.1.4+git${SRCPV}"
SRCREV = "7801e2fdbca8fd6445e76365ef7011bcac1b6cfa"
